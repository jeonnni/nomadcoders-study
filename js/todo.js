...
function paintToDo(newTodo){
    ...
    time.innerText = newTodo.createdAt? formatTime(newTodo.createdAt): "";

    const buttonToDo = document.createElement("button");
    buttonToDo.innerText = "🗑️";
    buttonToDo.addEventListener("click",deleteToDo)

    liToDo.appendChild(buttonToDo); // 왼쪽 삭제 버튼
    liToDo.appendChild(spanToDo); // 가운데 todo
    liToDo.appendChild(time); // 오른쪽 시간
